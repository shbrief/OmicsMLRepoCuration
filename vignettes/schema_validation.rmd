...
# Validate
validation_results <- validateDataAgainstSchema(valid_data, schema)
...
# Validate
validation_results_missing <- validateDataAgainstSchema(invalid_data_missing, schema)
...
# Validate
validation_results_types <- validateDataAgainstSchema(invalid_data_types, schema)
...
age_group_def <- getFieldDefinition(schema, "age_group")
...
validation_enum_valid <- validateDataAgainstSchema(enum_valid_data, schema)
...
ancestry_def <- getFieldDefinition(schema, "ancestry")
...
ancestry_details_def <- getFieldDefinition(schema, "ancestry_details")
...
# Validate
validation_ancestry <- validateDataAgainstSchema(ancestry_data, schema)
...
if ("disease" %in% names(schema)) {
  disease_def <- getFieldDefinition(schema, "disease")
...
# Validate
validation_multi <- validateDataAgainstSchema(multivalued_data, schema)
...
# Validate
results <- validateDataAgainstSchema(real_data, schema)
...
cat("Required fields present:", 
    all(getRequiredFields(schema) %in% colnames(real_data)), "\n")
```
